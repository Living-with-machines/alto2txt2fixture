...
FILE_NAME_DIGIT_PADDING_DEFAULT: int = 6
...
def save_fixture(
    ...
    filename_digit_padding: int = FILE_NAME_DIGIT_PADDING_DEFAULT,
) -> None:
    ...
    Args:
        ...
        file_name_digit_padding:
            Number of zeros to prefix the number of each fixture filename.
    ...
    for item in generator:
        ...
        if internal_counter > max_elements_per_file:
            file_name = f"{prefix}-{str(counter).zfill(filename_digit_padding)}.json"
            write_json(
